            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <Link to="/" className="flex items-center gap-3 mb-6 cursor-pointer">
                            <div className="h-12 w-12 bg-white rounded-lg flex items-center justify-center overflow-hidden">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-md">
                            Un emprendimiento familiar peruano dedicado a ofrecer ropa, zapatos y accesorios de segunda mano en excelente estado. Moda con historia, calidad y precios justos. 💚
                        </p>
                        {/* Social Links */}
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="font-display font-bold uppercase tracking-widest text-sm mb-6 text-gray-300">
                            Tienda
                        </h4>
                ...
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-xs text-gray-500 text-center md:text-left">
                        © {currentYear} Eguva. Hecho con 💚 en Perú.
                    </p>
                    <p className="text-xs text-gray-500 mt-2 md:mt-0">
                        Moda sostenible • Segunda mano • Calidad garantizada
                    </p>
                </div>
            </div>
        </footer>
